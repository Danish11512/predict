...
**Scope so far:** project layout, env templates, health check, Vite proxy, and **Kalshi-signed** REST helpers plus optional routes (`/kalshi/portfolio/balance`, `/kalshi/markets`, `/kalshi/ws/smoke`) when credentials are set. Order placement and streaming UI are not implemented yet.
