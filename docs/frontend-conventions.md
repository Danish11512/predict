...
- **Theme**: `resolveInitialTheme` / `applyThemeToDocument` / `persistTheme` live in `frontend/src/lib/utils/theme.ts`; tab definitions in `frontend/src/lib/constants/appHeaderTabs.ts`.
